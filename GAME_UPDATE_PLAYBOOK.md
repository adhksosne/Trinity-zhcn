...
table-cap write. The engine-safe UI limit is hard-coded to 700 (the former
`kMaxInventorySlots` constant was removed after the engine rejected larger caps);
validate the engine's actual capacity behavior.
