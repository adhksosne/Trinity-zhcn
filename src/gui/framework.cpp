...
namespace trinity::ui
{
    ...
    void InitStyle(float uiScale)
    {
        ...
        float bodySize  = (21.0f * g_scale < 36.0f) ? 21.0f * g_scale : 36.0f;
        float boldSize  = (21.0f * g_scale < 36.0f) ? 21.0f * g_scale : 36.0f;
        float titleSize = (30.0f * g_scale < 48.0f) ? 30.0f * g_scale : 48.0f;
        ...
        if (st.useCustomFont && st.customFont[0] != '\0' && GetFileAttributesA(st.customFont) != INVALID_FILE_ATTRIBUTES)
        {
            ...
            bodySize  = (22.0f * g_scale < 36.0f) ? 22.0f * g_scale : 36.0f;
            boldSize  = (22.0f * g_scale < 36.0f) ? 22.0f * g_scale : 36.0f;
            titleSize = (35.0f * g_scale < 48.0f) ? 35.0f * g_scale : 48.0f;
        }
        else if (st.builtInFontIndex == 1 && GetFileAttributesA(impactPath) != INVALID_FILE_ATTRIBUTES)
        {
            ...
            bodySize  = (22.0f * g_scale < 36.0f) ? 22.0f * g_scale : 36.0f;
            boldSize  = (22.0f * g_scale < 36.0f) ? 22.0f * g_scale : 36.0f;
            titleSize = (34.0f * g_scale < 48.0f) ? 34.0f * g_scale : 48.0f;
        }
        else if (st.builtInFontIndex == 2 && (GetFileAttributesA(georgiaBdPath) != INVALID_FILE_ATTRIBUTES || GetFileAttributesA(georgiaPath) != INVALID_FILE_ATTRIBUTES))
        {
            ...
            primaryBold = gPath;
            primaryTitle = gPath;
            bodySize  = (21.0f * g_scale < 36.0f) ? 21.0f * g_scale : 36.0f;
            boldSize  = (21.0f * g_scale < 36.0f) ? 21.0f * g_scale : 36.0f;
            titleSize = (32.0f * g_scale < 48.0f) ? 32.0f * g_scale : 48.0f;
        }
