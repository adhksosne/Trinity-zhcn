...
namespace trinity::game
{
    namespace
    {
        struct ItemPair { const char* key; const char* name; };
        const ItemPair kItemMap[] = {
            ...
            { "Bamboo_Branch_01_III", "Bamboo Sapling Stalk" },
            { "Bamboo_Branch_01_IV", "Perennial Bamboo Stalk" },
            { "Bamboo_Branch_01_IX", "Sacred Bamboo Stalk" },
            { "Bamboo_Branch_01_V", "Mature Bamboo Stalk" },
            { "Bamboo_Branch_01_VI", "Giant Bamboo Stalk" },
            { "Bamboo_Branch_01_VII", "Ancient Bamboo Stalk" },
            { "Bamboo_Branch_01_VIII", "Spirit Bamboo Stalk" },
            { "Bamboo_Branch_01_X", "World Bamboo Stalk" },
            { "Bamboo_Branch_02", "Sturdy Bamboo Stalk" },
            { "Bamboo_Branch_02_II", "Sturdy Bamboo Shoot" },
            { "Bamboo_Branch_02_III", "Sturdy Bamboo Sapling Stalk" },
            { "Bamboo_Branch_02_IV", "Sturdy Perennial Bamboo Stalk" },
            { "Bamboo_Branch_02_IX", "Sturdy Sacred Bamboo Stalk" },
            { "Bamboo_Branch_02_V", "Sturdy Mature Bamboo Stalk" },
            { "Bamboo_Branch_02_VI", "Sturdy Giant Bamboo Stalk" },
            { "Bamboo_Branch_02_VII", "Sturdy Ancient Bamboo Stalk" },
            { "Bamboo_Branch_02_VIII", "Sturdy Spirit Bamboo Stalk" },
            { "Bamboo_Branch_02_X", "Sturdy World Bamboo Stalk" },
            { "Bamboo_Branch_Hard_Usable", "Rough and Sturdy Bamboo Stalk" },
            ...
            { "Book_Investigation_GoldleafGuildhouse", "Investigative Log: Extinguishing the Last Flames" },
            { "Book_Investigation_Log", "Investigative Log: Shadows in the Village" },
            { "Book_KukuBirdJournal", "Leaping Kuku Bird Research Journal" },
            ...
            { "CraftingRecipe_Oongka_PlateArmor_Armor_III", "Belkandor Plate Armor Blueprint" },
            { "CraftingRecipe_Oongka_PlateArmor_Boots_III", "Belkandor Plate Boots Blueprint" },
            { "CraftingRecipe_Oongka_PlateArmor_Cloak_III", "Belkandor Plate Cloak Blueprint" },
            { "CraftingRecipe_Oongka_PlateArmor_Gloves_III", "Belkandor Plate Gloves Blueprint" },
            ...
            { "Goblin_Merchant_Fabric_Armor_ï¿½ï¿½ï¿½", "Goldleaves' Cloth Armor" },
            { "Goblin_Merchant_Fabric_Cloak_ï¿½ï¿½ï¿½", "Goldleaves' Cloth Cloak" },
            ...
            { "Item_AbyssArtifact_Chest_2_7", "Unstable Artifact Chest" },
            { "Item_AbyssArtifact_Chest_3", "Small Artifact Chest" },
            { "Item_AbyssArtifact_Chest_5", "Medium Artifact Chest" },
            { "Item_AbyssGear_Recipe_Box_I", "Unidentified Abyss Gear Recipe" },
            { "Item_AbyssGear_Recipe_Box_II", "Unidentified Abyss Gear Recipe" },
            { "Item_AbyssGear_Recipe_Box_III", "Unidentified Abyss Gear Recipe" },
            { "Item_AbyssGear_Recipe_Box_IV", "Unidentified Abyss Gear Recipe" },
            { "Item_AbyssGear_Recipe_Box_V", "Unidentified Abyss Gear Recipe" },
            { "Item_AbyssGear_Recipe_Box_VI", "Unidentified Abyss Gear Recipe" },
            ...
            { "Item_Kuku_Egg", "Old Kuku Bird's Egg" },
            ...
            { "Item_Pinball_Coin", "Marni Token" },
            { "Item_Pinball_Coin_Reward_Bag", "Material Box of Fortune" },
            ...
            { "Item_gimmick_gemstone_hanger_top_chandelier_0103", "Icy White Starcluster Light" },
            { "Item_gimmick_gemstone_hanger_top_chandelier_0103_index01", "Twilight Starcluster Light" },
            { "Item_gimmick_gemstone_hanger_top_chandelier_0103_index02", "Lilac Starcluster Light" },
            ...
            { "Item_gimmick_in_dpf_carpet_0001", "Round Twilight Floral Carpet" },
            { "Item_gimmick_in_dpf_carpet_0002", "Mist-woven Carpet" },
            { "Item_gimmick_in_dpf_carpet_0003", "Frost-woven Carpet" },
            { "Item_gimmick_in_dpf_carpet_0004", "Moonlit Garden Carpet" },
            { "Item_gimmick_in_dpf_carpet_0005", "Rhombic Vermillion Carpet" },
            { "Item_gimmick_in_dpf_carpet_0006", "Large Twilight Floral Carpet" },
            { "Item_gimmick_in_dpf_carpet_0006_index01", "Large Moonlit Garden Carpet" },
            { "Item_gimmick_in_dpf_carpet_0007", "Large Stone Knotted Carpet" },
            { "Item_gimmick_in_dpf_carpet_0008", "Sunset Plaid Carpet" },
            { "Item_gimmick_in_dpf_carpet_0008_index01", "Double Mist-woven Carpet" },
            { "Item_gimmick_in_dpf_carpet_0009", "Large Rosy Dragonscale Carpet" },
            { "Item_gimmick_in_dpf_carpet_0010", "Wide Sunset Plaid Carpet" },
            { "Item_gimmick_in_dpf_carpet_0010_index01", "Wide Hushed Earth Carpet" },
            { "Item_gimmick_in_dpf_carpet_0011", "Wide Sunlit Garden Carpet" },
            { "Item_gimmick_in_dpf_carpet_0011_index01", "Wide Mist-woven Carpet" },
            { "Item_gimmick_in_dpf_carpet_0012", "Long Sunset Plaid Carpet" },
            { "Item_gimmick_in_dpf_carpet_0012_index01", "Long Mist-woven Carpet" },
            ...
            { "Item_gimmick_tool_saw_0001", "Crude Saw" },
            { "Item_gimmick_tool_saw_0001_lv1", "Sharp Saw" },
            ...
            { "KuKubird_Armor", "Kuku Bird Hatchling Saddle" },
            ...
            { "Legend_Macaw_Parrot_Report", "Sighting of the Hyacinth Macaw" },
            { "Legend_Machine_Eagle_Report", "Sighting of the Iron Eagle" },
            ...
            { "NoticePaper_Circus_Chairless", "Invitation to the Demeniss Circus" },
            { "NoticePaper_Circus_ComeRightNow", "Invitation to the Demeniss Circus" },
            { "NoticePaper_Circus_DontMissIt", "Invitation to the Demeniss Circus" },
            ...
            { "PetArmor_Marni_Armor", "Cat Visionette Neckerchief" },
            { "PetArmor_Marni_Helm", "Cat Visionette" },
            ...
            { "Pet_Attackable_Amulet", "Sigil of Valor" },
            { "Pet_Bond_Amulet", "Sigil of Bonding" },
            { "Pet_Huntable_Amulet", "Hunter's Sigil" },
            ...
            { "Quest_Paper_ContributionShop_Hernand", "Hernand Contribution Office Flyer" },
            ...
            { "Quest_Paper_Lumberjack_Testimony", "Lumberjacks' Witness Report" },
            ...
            { "Visione_Chip_Suspiciouscult", "The Crow and the Lunatic" },
            ...
            { "Wood_Branch_01_II", "Sprout Branch" },
            { "Wood_Branch_01_III", "Sapling Branch" },
            { "Wood_Branch_01_IV", "Perennial Branch" },
            { "Wood_Branch_01_IX", "Sacred Tree Branch" },
            { "Wood_Branch_01_V", "Mature Tree Branch" },
            { "Wood_Branch_01_VI", "Giant Tree Branch" },
            { "Wood_Branch_01_VII", "Ancient Tree Branch" },
            { "Wood_Branch_01_VIII", "Spirit Tree Branch" },
            { "Wood_Branch_01_X", "World Tree Branch" },
            { "Wood_Branch_02", "Sturdy Tree Branch" },
            { "Wood_Branch_02_II", "Sturdy Sprout Branch" },
            { "Wood_Branch_02_III", "Sturdy Sapling Branch" },
            { "Wood_Branch_02_IV", "Sturdy Perennial Branch" },
            { "Wood_Branch_02_IX", "Sturdy Sacred Tree Branch" },
            { "Wood_Branch_02_V", "Sturdy Mature Tree Branch" },
            { "Wood_Branch_02_VI", "Sturdy Giant Tree Branch" },
            { "Wood_Branch_02_VII", "Sturdy Ancient Tree Branch" },
            { "Wood_Branch_02_VIII", "Sturdy Spirit Tree Branch" },
            { "Wood_Branch_02_X", "Sturdy World Tree Branch" },
            { "Wood_Branch_Hard_Usable", "Rough and Sturdy Tree Branch" },
            ...
            { "wyvern_Armor", "Wyvern Saddle" },
        };

        struct MapInit {
            std::unordered_map<std::string, const char*> map;
            MapInit() {
                map.reserve(sizeof(kItemMap) / sizeof(kItemMap[0]));
                for (const auto& item : kItemMap) {
                    map[item.key] = item.name;
                }
            }
        };

        static const MapInit s_itemMapInit;
    }

    const char* ResolveItemDisplayName(const char* key)
    {
        if (!key || key[0] == '\0') return nullptr;
        auto it = s_itemMapInit.map.find(key);
        if (it != s_itemMapInit.map.end()) return it->second;
        return nullptr;
    }
}
